...
echo -e "$red Exemplo1:$f\n 1 - Exibir status da utilização das partições do sistema;(df -h)\n 2 - Exibir relação de usuário logados; (who)\n 3 - Exibir data/hora; (date)\n 4 - Sair.\n  $gre Informe sua opção: 1 $f/dev/hda3 9.9G 5.4G 4.16 57% / /dev/hda1 23M 6.5M 16M 30% /boot /dev/hda6 236 1.8G 20G 9% /home /dev/hda5 5.OG 3.2G 1.6G 68% /var shmfs 125M 0 125M 0% /dev/shm"
